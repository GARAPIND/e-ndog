...
@section('content')
    <div class="container my-5">
        <div class="text-center mb-5">
            ...
            <p class="lead text-muted">Terima kasih telah berbelanja di toko kami</p>
        </div>
            ...
            <div class="card-header bg-white py-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-success px-3 py-2 text-white">
                        <i class="fas fa-check me-1"></i> Pembayaran Sukses
                    </span>
                </div>
            </div>
            ...
            <div class="card-footer bg-white text-center py-4">
                <div class="row justify-content-center">
                    <div class="col-md-4 mb-2 mb-md-0">
                        <a href="{{ route('belanja.list') }}" class="btn btn-primary w-100">
