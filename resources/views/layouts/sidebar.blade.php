    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        @elseif ($role == 'kurir')
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    <li class="sidebar-item">
                        <a class="sidebar-link sidebar-link" href="{{ route('dashboard.kurir') }}"
                            aria-expanded="false">
                            <i data-feather="home" class="feather-icon"></i>
                            <span class="hide-menu">Dashboard</span>
                        </a>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('kurir.pesanan.index') }}" aria-expanded="false">
                            <i data-feather="truck" class="feather-icon"></i>
                            <span class="hide-menu">Kelola Pengiriman</span>
                        </a>
                    </li>

                    {{-- <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('kurir.history.index') }}" aria-expanded="false">
                            <i data-feather="clock" class="feather-icon"></i>
                            <span class="hide-menu">History Pesanan</span>
                        </a>
                    </li> --}}
